			...
			<div class="content">
				...
				<div class="row">
					<div class="col-6 col-12-medium">
						...
						<!-- Form -->
						<h3>Form</h3>
						<form method="post" action="${root}/user/register3"
							...
							<div class="row gtr-uniform">
								...
								<div class="col-6 col-12-small">
									<input type="checkbox" id="checkbox-alpha" name="conts"
										value="주식"> <label for="checkbox-alpha">무식</label>
								</div>
								<div class="col-6 col-12-small">
									<input type="checkbox" id="checkbox-beta" name="conts"
										value="펀드"> <label for="checkbox-beta">펀드</label>
								</div>
								<div class="col-6 col-12-small">
									<input type="checkbox" id="checkbox-gamma" name="conts"
										value="예금"> <label for="checkbox-gamma">예금</label>
								</div>
								<div class="col-6 col-12-small">
									<input type="checkbox" id="checkbox-theta" name="conts"
										value="적금"> <label for="checkbox-theta">적금</label>
								</div>
								<div class="col-6 col-12-small">
