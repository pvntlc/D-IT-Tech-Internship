...
<div id="navbar">
  <ul>
    ...
    <li class="nav-item"><a href="${root}/user.do?action=PERSONAL">개인</a></li>
    <li class="nav-item"><a href="${root}/user.do?action=COMPANY">기업</a></li>
...
<c:if test="${not empty  user}">  
	...
	<li class="nav-item"><a href="${root}/user.do?action=LIST">유저 정보 확인</a></li>
</c:if>
