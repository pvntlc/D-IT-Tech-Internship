	...
	<div class="container" id="container">
		<div class="form-container sign-in-container">
			<form method="POST" action="AccountServlet?action=REG">
				...
				<input type="text" id="aseq" name="aseq" value="계좌번호" required />
				<input type="text" id="cseq" name="cseq" value="고객번호" required />
				<input type="text" id="pseq" name="pseq" value="상품번호" required />
